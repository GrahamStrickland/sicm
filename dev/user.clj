...
(def index
  "notebooks/GrahamStrickland/sicm.clj")
...
(def defaults
  {;; NOTE by default, your project's first notebook is registered as its index;
   ...
   ;; namespaces loaded by `dev/GrahamStrickland/sci_extensions.cljs`.

   ;; :cljs-namespaces '[GrahamStrickland.sci-extensions]
   })
...
(def static-defaults
  (assoc defaults
         ...
         :paths ["notebooks/**.clj"]
         :cname ""
         :git/url "https://github.com/GrahamStrickland/sicm"))
