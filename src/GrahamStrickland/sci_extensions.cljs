(ns GrahamStrickland.sci-extensions
    (:require [GrahamStrickland.custom]
              [emmy.sci]
              [sci.ctx-store]
              [sci.core :as sci]))
...
(def custom-namespace
  (sci/copy-ns GrahamStrickland.custom
               (sci/create-ns 'GrahamStrickland.custom)))
...
(def custom-namespaces
  {'GrahamStrickland.custom custom-namespace
...
;; `:as` form to a namespace: `(:require [GrahamStrickland.custom :as custom])`
(def custom-aliases
  {'custom 'GrahamStrickland.custom})
