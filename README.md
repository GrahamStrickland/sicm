...
ClojureScript build. See `dev/GrahamStrickland/sci_extensions.cljs` for more
information.
...
```clj
(clerk/show! "notebooks/GrahamStrickland/sicm.clj")
```
...
This is made possible by the code in `src/GrahamStrickland/sci_viewers.cljs`. If you
...
- [Create a GitHub repository](https://github.com/new). Ideally the owner
  matches `GrahamStrickland` and the project name is `sicm`.
...
git branch -M main
git remote add origin git@github.com:GrahamStrickland/sicm.git
git push -u origin main
```

Then visit https://github.com/GrahamStrickland/sicm to see your site.
...
By default your site will live at https://GrahamStrickland.github.io/sicm.
...
https://github.clerk.garden/GrahamStrickland/sicm
